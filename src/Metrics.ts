...
export class Metrics {
    ...
    public readonly connections = new Gauge({ name: "hookshot_connections", help: "The number of active hookshot connections", labelNames: ["type"], registers: [this.registry]});
