...
export type IssuesGetResponseData =
  Endpoints["GET /repos/{owner}/{repo}/issues/{issue_number}"]["response"]["data"];
export type IssuesGetCommentResponseData =
...
export type PullsListRequestedReviewersResponseData =
  Endpoints["GET /repos/{owner}/{repo}/pulls/{pull_number}/requested_reviewers"]["response"]["data"];
export type ReposGetResponseData =
  Endpoints["GET /repos/{owner}/{repo}"]["response"]["data"];
export type ProjectsGetResponseData =
  Endpoints["GET /projects/{project_id}"]["response"]["data"];
export type ProjectsListForTeamsResponseData =
...
export type ProjectsListResponseData =
  | ProjectsListForTeamsResponseData
...
export type PullGetResponseData =
...
export type CreateInstallationAccessTokenDataType =
