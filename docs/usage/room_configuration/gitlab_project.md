...
5. If you have permission to bridge this repo, the bridge will respond with a confirmation message. (Users with `Maintainer` permissions or greater can bridge projects.)
